...
/// throw_recoverable_error_if_oom), anything else a std::runtime_error prefixed with `error_message`. Route
...
public:
	...
	void insert(duckdb::Connection& con, const table_def& table, const std::string& staging_table_name,
	            const std::vector<const column_def*>& columns_pk,
	            const std::vector<const column_def*>& columns_regular);

	void update_values(duckdb::Connection& con, const table_def& table, const std::string& staging_table_name,
	                   std::vector<const column_def*>& columns_pk, std::vector<const column_def*>& columns_regular,
	...
	std::string create_latest_active_records_table(duckdb::Connection& con, const table_def& source_table) const;

	void drop_latest_active_records_table(duckdb::Connection& con, const std::string& lar_table_name) const;
	...
	void truncate_table(duckdb::Connection& con, const table_def& table, const std::string& synced_column,
	                    std::chrono::nanoseconds& cutoff_ns, const std::string& deleted_column);

	void delete_rows(duckdb::Connection& con, const table_def& table, const std::string& staging_table_name,
	                 std::vector<const column_def*>& columns_pk);
	...
	void delete_historical_rows(duckdb::Connection& con, const table_def& table, const std::string& staging_table_name,
	                            std::vector<const column_def*>& columns_pk);

	// Migration operations

	// Drop the destination table
	void drop_table(duckdb::Connection& con, const table_def& table, const std::string& log_prefix);
	...
	void drop_column_in_history_mode(duckdb::Connection& con, const table_def& table, const std::string& column,
	...
	void add_column_in_history_mode(duckdb::Connection& con, const table_def& table, const column_def& column,
	...
	void update_column_value(duckdb::Connection& con, const table_def& table, const std::string& column,
	...
	void migrate_soft_delete_to_live(duckdb::Connection& con, const table_def& table,
	                                 const std::string& soft_deleted_column);
	...
	void migrate_live_to_soft_delete(duckdb::Connection& con, const table_def& table,
	                                 const std::string& soft_deleted_column);
