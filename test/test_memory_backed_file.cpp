...
TEST_CASE("MemoryBackedFile::Create gives valid file descriptor", "[memory_backed_file]") {
...
TEST_CASE("MemoryBackedFile grows in size when writing many bytes", "[memory_backed_file]") {
